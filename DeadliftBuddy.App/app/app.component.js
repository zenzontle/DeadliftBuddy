...
var AppComponent = (function () {
    ...
    AppComponent.prototype.getIt = function () {
        var _this = this;
        this.routineService.getRoutines().subscribe(function (response) {
            if (response) {
                _this.routine = response.toString();
            }
            else {
                _this.routine = 'Not found';
            }
        });
    };
    return AppComponent;
